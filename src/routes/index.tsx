        ...
        <header className="px-6 pt-24 pb-12 border-b border-border">
          <div className="max-w-6xl">
            <div className="flex gap-8 md:gap-12 items-start animate-reveal [animation-delay:100ms]">
              <h1 className="text-7xl md:text-[10vw] font-display font-extrabold leading-[0.9] tracking-tighter text-balance">
                FRÅN <br />
                <br />
              ...
              <div className="self-stretch w-px bg-foreground" aria-hidden="true" />
              <div className="flex flex-col gap-6 pt-2">
                <h2 className="text-4xl md:text-[5vw] font-display font-extrabold leading-[0.9] tracking-tighter">
                  DG Development
                </h2>
